          ...
          column = ( <Table hover striped>
            <thead>
              ...
              <th onClick={this.onSort('id')}>Id <FontAwesomeIcon icon={this.setArrow('id')}/></th>
                ...
                <th ><Link to={{ pathname: '/addCage', state: { from: '/cages/'}}}><Button outline color="success" size="sm" id="addAnimal"><FontAwesomeIcon icon={Icons.faPlus}/></Button></Link> 
          ...
          column = ( <Table hover striped>
            <thead>
              <tr>
                ...
                <th onClick={this.onSort('description')}>Description <FontAwesomeIcon icon={this.setArrow('description')}/></th>
                <th onClick={this.onSort('taille')}>Taille <FontAwesomeIcon icon={this.setArrow('taille')}/></th>
                <th ><Link to={{ pathname: '/addCage', state: { from: '/cages/'}}}><Button outline color="success" size="sm" id="add"><FontAwesomeIcon icon={Icons.faPlus}/></Button></Link> 
