          ...
          column = ( <Table hover striped>
            <thead>
              ...
              <th onClick={this.onSort('id')}>Id <FontAwesomeIcon icon={this.setArrow('id')}/></th>
                ...
                <th ><Link to={{ pathname: '/addStaff', state: { from: '/staffs/'}}}><Button outline color="success" size="sm" id="addAnimal"><FontAwesomeIcon icon={Icons.faPlus}/></Button></Link> 
          ...
          column = ( <Table hover striped>
            <thead>
              <tr>
                ...
                <th ><Link to={{ pathname: '/addStaff', state: { from: '/staffs/'}}}><Button outline color="success" size="sm" id="add"><FontAwesomeIcon icon={Icons.faPlus}/></Button></Link> 
